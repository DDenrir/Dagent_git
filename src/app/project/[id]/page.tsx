...
export default async function ProjectDetail({ params }: { params: Promise<{ id: string }> }) {
    ...
    const projects: Record<string, any> = {
        "1": {
            id: "1",
            titleTh: "อิทธิพลความโปร่งใสของห่วงโซ่อุปทานและการจัดการความเสี่ยงที่มีผลต่อประสิทธิภาพการดำเนินงานของวิสาหกิจชุมชน",
            titleEn: "The Influence of Supply Chain Transparency and Risk Management on Operational Performance of Community Enterprises",
            ...
            status: "ดำเนินการ",
            abstract: "การวิจัยนี้มีวัตถุประสงค์เพื่อศึกษาอิทธิพลของความโปร่งใสของห่วงโซ่อุปทานและการจัดการความเสี่ยงที่มีผลต่อประสิทธิภาพการดำเนินงานของวิสาหกิจชุมชน ในจังหวัดเพชรบูรณ์..."
        },
        "2": {
            id: "2",
            titleTh: "อิทธิพลของคุณลักษณะผู้นำทางความคิดที่มีต่อการตัดสินใจซื้อสินค้า OTOP ผ่านช่องทางออนไลน์ของผู้บริโภค",
            titleEn: "The Influence of Opinion Leadership Characteristics on Consumer Online Purchasing Decisions of OTOP Products",
            ...
            fundingType: "ทุนภายในคณะ",
            status: "ดำเนินการ",
            abstract: "การศึกษาวิจัยครั้งนี้มีวัตถุประสงค์เพื่อศึกษาอิทธิพลของคุณลักษณะผู้นำทางความคิดที่มีต่อการตัดสินใจซื้อสินค้า OTOP ผ่านช่องทางออนไลน์..."
        },
        "3": {
            id: "3",
            titleTh: "การพัฒนาเว็บไซต์ประชาสัมพันธ์ผ้าทอไทหล่ม อำเภอหล่มสัก จังหวัดเพชรบูรณ์",
            titleEn: "Development of a Public Relations Website for Tai Lom Woven Fabric, Lom Sak District, Phetchabun Province",
            ...
            fundingType: "ทุนภายในคณะ",
            status: "ดำเนินการ",
            abstract: "โครงการนี้มุ่งเน้นการพัฒนาเว็บไซต์เพื่อส่งเสริมและประชาสัมพันธ์ผ้าทอไทหล่ม ซึ่งเป็นภูมิปัญญาท้องถิ่นอันทรงคุณค่า..."
        }
    };
                    ...
                    <div className={styles.card}>
                        <div className={styles.cardBody}>
                            ...
                            <div className={styles.detailRow}>
                                ...
                                <div className={styles.detailValue}>{project.researcher} ({project.faculty})</div>
                            </div>
