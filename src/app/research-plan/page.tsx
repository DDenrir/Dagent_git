              ...
              <div key={plan.id} className={styles.planItem}>
                <div className={styles.planCard}>
                  ...
                  <div className={styles.planDetails}>
                    <div className={styles.detailItem}>
                      ...
                      <span className={styles.detailValue}>
                        <i className="fa fa-user-circle"></i> {plan.leader}
                      </span>
                    </div>
                    <div className={styles.detailItem}>
                    ...
                    <div className={styles.detailItem}>
                      ...
                      <span
                        className={`${styles.statusIndicator} ${plan.status === 'กำลังดำเนินการ' ? styles.statusActive : styles.statusCompleted}`}
                      >
                  ...
                  <div className={styles.detailItem}>
                    ...
                    <p className={styles.objectivesText}>{plan.objectives}</p>
                  </div>
                </div>
              </div>
            ))}
